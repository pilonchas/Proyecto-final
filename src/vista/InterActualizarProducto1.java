 ...
 * @author FERNANDO
 */
public class InterActualizarProducto1 extends javax.swing.JInternalFrame {

    //variables
    int idProducto = 0;
    int cantidad = 0;

    public InterActualizarProducto1() {
        initComponents();
        setTitle("Actualizar lista de los Productos");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualizar lista de Productos");
            ...
            if (!txt_cantidad_nueva.getText().isEmpty()) {
                ...
                if (validacion == true) {
                    ...
                    if (Integer.parseInt(txt_cantidad_nueva.getText()) > 0) {
                        ...
                        int listaActual = Integer.parseInt(txt_cantidad_actual.getText().trim());
                        int listaNuevo = Integer.parseInt(txt_cantidad_nueva.getText().trim());

                        listaNuevo = listaActual + listaNuevo;
                        producto.setCantidad(listaNuevo);
                        if (controlProducto.actualizarStock(producto, idProducto)) {
                            ...
                            JOptionPane.showMessageDialog(null, "Error al Actualizar lista");
                        }
                    } else {
                ...
                JOptionPane.showMessageDialog(null, "Ingrese una nueva cantidad para sumar el lista del producto");
            }
        } else {
    ...
    //metodo para mostrar lista del producto seleccionado
